...
const WELLBEING_CARDS = [
    ...
    },
    {
        ...
        description: 'You reach for your phone dozens of times without conscious thought - during conversations, red lights, even while walking. It's automatic.',
        ...
        strategies: [
            ...
            'Practice the 5-second rule: pause for 5 seconds before unlocking your phone and ask what you're looking for'
        ]
    },
    {
        id: 'screen-time-4',
        ...
        description: 'You check work emails in the evening, respond to messages on weekends, and feel guilty when you're not available. Boundaries feel impossible in teaching or support roles.',
        treatment: 'Establish Clear Work-Life Tech Boundaries',
        strategies: [
            'Set specific "office hours" when you're available and communicate them clearly',
    ...
    },
    {
        ...
        description: 'You feel pressured to respond immediately to every message. Colleagues, students, or family expect instant replies, and you've trained them to expect this.',
    ...
    },
    {
        ...
        description: 'You're in dozens of group chats that ping constantly. Keeping up feels impossible, but fear of missing something important keeps you checking.',
        treatment: 'Curate and Control Group Communications',
        strategies: [
            'Mute notifications for all but essential group chats',
            'Leave groups that don't serve you anymore - it's okay to opt out',
    ...
    },
    {
        ...
        description: 'Your entire day is reactive - you respond to each notification as it comes. You never enter deep work because you're constantly interrupted.',
        ...
        strategies: [
            ...
            'Start your day with YOUR priority, not your inbox's demands'
        ]
    },
    ...
    // INFORMATION OVERLOAD (4 cards)
    {
        ...
        description: 'You compulsively check news throughout the day. You feel anxious and powerless, but can't stop refreshing. Every headline feels urgent.',
    ...
    },
    {
        ...
        strategies: [
            ...
            'Remember: You're comparing your inside to their outside, their curated moments to your entire reality',
    ...
    },
    {
        ...
        strategies: [
            ...
            'Use the "save less, consume now" approach: If it's not worth engaging with immediately, it probably isn't worth saving',
    ...
    },
    {
        ...
        strategies: [
            ...
            'Notice when you're genuinely learning vs. procrastinating through research'
        ]
    },
    ...
    // WORK-LIFE BALANCE (4 cards)
    {
        ...
        description: 'You check and respond to work emails in the evenings and weekends. It feels like if you don't, you'll fall behind or miss something critical.',
    ...
    },
    {
        ...
        description: 'Even when you're not working, you're thinking about work. Your mind is always partly in lesson planning, student concerns, or admin tasks.',
        ...
        strategies: [
            ...
            'Write down tomorrow's priorities before finishing - this helps your brain let go',
    ...
    },
    {
        ...
        strategies: [
            ...
            'Accept "good enough" for Monday - perfection isn't required',
    ...
    },
    {
        ...
        description: 'You eat lunch at your desk while working or scrolling. You can't remember the last time you took a real break during the day.',
    ...
    // SLEEP & EVENING USE (3 cards)
    {
        ...
        description: 'You get into bed intending to sleep, but spend 30-90 minutes scrolling through social media, news, or videos. You can't seem to put the phone down.',
        ...
        strategies: [
            ...
            'Buy a dedicated alarm clock if that's your excuse for keeping your phone nearby',
    ...
    },
    {
        ...
        description: 'You have 30+ tabs open at all times. Your browser is overwhelming. You can't find what you need and constantly feel mentally cluttered.',
        ...
        strategies: [
            ...
            'Accept that if you haven't looked at a tab in 3 days, you don't need it open'
        ]
    },
    {
        id: 'focus-3',
        ...
        description: 'You can't get into deep focus. Every time you start to concentrate, a notification pulls you out. You haven't experienced "flow" in months.',
        ...
        strategies: [
            ...
            'Communicate your focus time to colleagues: "I'm unreachable during my focus blocks"'
        ]
    },
    {
        id: 'focus-4',
        ...
        description: 'You're constantly doing things - responding to emails, attending meetings, checking systems - but never accomplishing your most important work. Days end with exhaustion but nothing significant completed.',
        ...
        strategies: [
            ...
            'Learn to say no to meetings and requests that don't serve your core priorities'
        ]
    },
    ...
    // SOCIAL MEDIA (3 cards)
    {
        ...
        description: 'You open social media apps without thinking—during conversations, waiting, walking between rooms. It's completely automatic and mindless.',
        treatment: 'Add Friction to Automatic Habits',
        strategies: [
    ...
    },
    {
        ...
        description: 'You check how many likes or reactions your posts get repeatedly. Your mood rises and falls with social media metrics. You feel rejected when posts don't perform well.',
        ...
        strategies: [
            ...
            'Remind yourself: Online metrics don't measure your value or impact'
        ]
    },
    {
        id: 'social-3',
    ...
    },
    {
        ...
        strategies: [
            ...
            'Ensure you're taking real breaks, not just switching between screens'
        ]
    }
];
